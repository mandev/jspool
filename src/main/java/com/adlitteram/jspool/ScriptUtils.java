...
public class ScriptUtils {
  ...
  public static ThreadPoolExecutor createFifoExecutor(int p) {
    ...
    return new ThreadPoolExecutor(
        nproc, nproc, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingDeque<>());
  }

  public static Builder createXomBuilder(
      final boolean processComment, final boolean processProcessingInstruction) {
    NodeFactory factory =
        new NodeFactory() {
          ...
          public Nodes makeProcessingInstruction(String str, String str1) {
            return processProcessingInstruction
                ? super.makeProcessingInstruction(str, str1)
                : new Nodes();
          }
        };
