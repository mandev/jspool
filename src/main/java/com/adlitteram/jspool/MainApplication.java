...
public class MainApplication extends Application {
  ...
  public static final String USER_CONF_DIR =
      PlatformUtils.HOME_DIR + "." + Update.getNAME() + File.separator;
  ...
  public void start() {
    SwingUtilities.invokeLater(() -> mainFrame = new MainFrame(actionManager));
  }
  ...
  public void quit() {
    ...
    mainFrame.getChannels().forEach(Channel::stop);
