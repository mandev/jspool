/**
 * FtpMove.java Copyright (C) 2002 Emmanuel Deviller
 *
 * @version 2.0
...
public class FtpMove extends AbstractTarget {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FtpMove.class);
    //
    ...
    public boolean setParameters() {
        ...
        channel.setProperty(FTPTARGET_MODE, Integer.valueOf(modeCombo.getSelectedIndex()));
