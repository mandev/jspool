/**
 * FtpDir.java Copyright (C) 2002 Emmanuel Deviller
 *
 * @version 2.0
...
public class MailSource extends AbstractSource {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MailSource.class);
    //
    ...
    public boolean run(AbstractTarget target) {
        ...
        try {
            ...
            if ( "pop3".equals(mailConnex.getMode())) mailConnex.close(); 
        }
        catch (Exception e) {
            logger.warn("MailSource.run()", e);
            mailConnex.close();
            mailConnex = null;
            status = false;
        }
    ...
    public boolean setParameters() {
        ...
        channel.setProperty(MAILSOURCE_MODE, Integer.valueOf(modeCombo.getSelectedIndex()));
        return true;
    }
}
