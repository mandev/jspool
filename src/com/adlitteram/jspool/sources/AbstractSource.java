/**
 * AbstractSource.java Copyright (C) 2002 Emmanuel Deviller
 *
 * @version 1.0
        ...
        for (int i = 0; i < maxFiles; i++) {
            ...
            if (srcFile == null) {
                ...
                if (srcFile.isStabilized()) {
                    //logger.info("Stabilized File - Channel " + channel.getID() + " - " + file.getPath());
    ...
    public boolean processDir(SourceFile dir, AbstractTarget target) {
        ...
        for (int i = 0; i < maxFiles; i++) {
            ...
            if (scrcFile.isStabilized()) {
                ...
                //logger.info("Stabilized File - Channel " + channel.getID() + " - " + file.getPath() + " - " + c);
