...
public class ChannelDialog extends JDialog {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ChannelDialog.class);
    //
    public static int OK = 0;
    public static int CANCEL = 1;
    private final Channel channel;
    private final MainFrame frame;
    private final JTextField identField, tempoField, stabiField, filterField, maxField, delSubdirField;
    private final JCheckBox recCheck, zeroCheck, autostartCheck;
    private JPanel srcPanel, modePanel;
    private JComboBox modeCombo, srcCombo;
    ...
    JPanel buildSrcPanel() {
        ...
        panel.setBorder(new TitledBorder(BorderFactory.createEtchedBorder(), Message.get("source.input")));
        panel.add(p0);
        panel.add(srcPanel);
        return panel;
    }
    ...
    JPanel buildModePanel() {
        ...
        p0.setBorder(new TitledBorder(BorderFactory.createEtchedBorder(), Message.get("target.output")));
    ...
    public void OKPressed() {
        ...
        if (identField.getText().length() < 2) {
            Utils.beep();
            logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning1"));
            return;
        }
        ...
        try {
            if (Float.parseFloat(tempoField.getText()) < 0.01) {
                Utils.beep();
                logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning3"));
                return;
            }
            ...
            Utils.beep();
            logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning4"));
            return;
        }
        ...
        try {
            if (Integer.parseInt(stabiField.getText()) < 0) {
                Utils.beep();
                logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning5"));
                return;
            }
            ...
            Utils.beep();
            logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning6"));
            return;
        }
        ...
        try {
            if (Integer.parseInt(maxField.getText()) < 0) {
                Utils.beep();
                logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning7"));
                return;
            }
            ...
            Utils.beep();
            logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning8"));
            return;
        }
        ...
        try {
            if (Long.parseLong(delSubdirField.getText()) < 0) {
                Utils.beep();
                logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning9"));
                return;
            }
            ...
            Utils.beep();
            logger.info(channel.getStringProp(Channel.ID) + " - " + Message.get("channel.warning10"));
            return;
        }
