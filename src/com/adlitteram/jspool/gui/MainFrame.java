/**
 * MainFrame.java Copyright (C) 2002 Emmanuel Deviller
 *
 * @version 2.1
...
//        XProp.put("MainFrame.divider", NumUtils.doubleArrayToString(splitPane.getProportions()));
    ...
    private void loadConfig() {
        try {
            ...
            if (file.exists()) {
                logger.info(Message.get("mainframe.loadConfig") + " " + file.getPath());
                XmlChannelReader.read(this, file.toURI());
            }
        }
        catch (Exception e) {
            logger.warn("MainFrame.loadConfig() : ", e);
        }
    ...
    public void addLogArea(Channel channel) {
        //logger.info("Adding LogArea for channel " + channel.getID()) ;
    ...
    public void saveConfig() {
        ...
        try {
            ...
            logger.warn("MainFrame.saveConfig() : ", ioe);
        }
    }
