...
function createXML() {
    ...
    for (var i in groupArray) {
        ...
        if (group.sport.name != "") {
            ...
            p0.appendChild(group.sport.name) ;
            intertitre0.appendChild(p0);
        ...
        if (group.district.name != "") {
            ...
            // Create Division header only if the District related contains a "#"
                ...
                if (group.district.name.matches("[#].*")) {
                    ...
                    if (distr.matches(".*[ ].*")) {
                        p1.appendChild(distr.substring(0,distr.indexOf(' ',0))) ;
                        intertitre1.appendChild(p1);
                        var p10 = new Element("p");
                        p10.appendChild(distr.substr(distr.indexOf(' ',0)+1,distr.length())) ;
                        intertitre1.appendChild(p10);
                    }
                    else {
                        p1.appendChild(distr) ;
                        intertitre1.appendChild(p1);
                    }
                }
                    ...
                    var p11 = new Element("p");
                    p11.appendChild(group.district.name) ;
                    intertitre1.appendChild(p11);
                }
        ...
        if (group.championship.name != "") {
            ...
            p2.appendChild(group.championship.name) ;
            intertitre2.appendChild(p2);
        ...
        if (group.name != "" && group.name != group.championship.name) {
            ...
            p3.appendChild(group.name) ;
            intertitre3.appendChild(p3) ;
        ...
        if (group.rankings != "") {
            ...
            var p5 = new Element("p") ;
            p5.appendChild("CLASSEMENT") ;
            intertitre5.appendChild(p5) ;
