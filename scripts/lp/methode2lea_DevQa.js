...
function processStory(storyFile, itemNode, linkedItems) {
    ...
    var photoEncadreNodes = itemNode.query("doc/article/texte/pbox [@class='encadre']");
...
function writeStory(storyNode, linkedItems) {
 ...
 //   }
    webElement.appendChild(createElement("primeRubric", getValue(storyNode, "doc/dbMetadata/Metadata/PubData/Digital/Priority") + ""));
...
function writeGallery(galleryNode, linkedItems) {
 ...
 //       webElement.appendChild(createElement("primeRubric", ""));
 //   }
    webElement.appendChild(createElement("primeRubric", getValue(galleryNode, "doc/dbMetadata/Metadata/PubData/Digital/Priority") + ""));
