...
//MAIL_TO_USER="redchef@leparisien.fr" ;
MAIL_TO_USER=["phuynh@leparisien.presse.fr", "shassini@leparisien.presse.fr"] ;
MAIL_FROM_USER="eidosmedia@leparisien.presse.fr" ;

STAGING_DIR = "C:/Inetpub/ftproot/web/contrib_xml_dev_tmp/" ;
OUTPUT_DIR = "C:/Inetpub/ftproot/web/contrib_xml_dev_tmp2/" ;
OUTPUT_DIR2 = "C:/Inetpub/ftproot/web/contrib_xml_dev_out/" ;

GS_PATH = "C:/Program Files/gs/gs9.02/bin/gswin32c.exe" ;
...
function buildZip() {  
    ...
    var ZIP_FILE = new File(OUTPUT_DIR2 + OUTPUT_NAME + ".zip") ;
...
function writeImage(imageItem, storyNode) {
    ...
    contentElement.appendChild(createElement("credit", ScriptUtils.clean(iptcData.credit)));  // change for Isabelle                
