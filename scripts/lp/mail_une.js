...
MAIL_USER="" ;         // authentification smtp : user
MAIL_PASSWD="" ;       // authentification smtp : password
MAIL_FROM_USER="info@leparisien.fr" ;
...
function sendMail(file) {
    _print("Mailing image " + file + " to " + MAIL_TO);
...
function main() {
    ...
    if ( jpgFile.exists() ) FileUtils.forceDelete(jpgFile) ;
    return _OK ;
}
