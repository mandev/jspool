...
//    var value0 = getValue(node, "DESCRIPTION/CONDITION/PARI/TYPEPARI") ;
    var value0 = "Quinté plus - Quarté plus - Tiercé - 2sur4 - Couplé - Trio - Couplé ordre" ;
...
function createXML() {
    ...
    td38.appendChild("PROPRIÉTAIRES") ;
    ...
    if (reunion.course.classe.equals("A")) td311.appendChild("TEMPS RECORDS") ; else td311.appendChild("DERNIÈRES PERFORMANCES") ;
