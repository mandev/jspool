...
OUTPUT_NAME = _getValue("OUTPUT_NAME") ;
...
function getOutput(name) {
	return ( name == "JJMMAAAA.jpg" ) ? FilenameUtils.removeExtension(_srcFile.getName()) + ".jpg" : name ;
}
...
function main() {
    ...
    var dstFile = new File (dstDir, getOutput(OUTPUT_NAME));
