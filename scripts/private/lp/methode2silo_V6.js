...
//TEMP_DIR = "C:/Exports/SILO/silo_tmp/";
//OUTPUT_DIR = "C:/Exports/SILO/silo_out/";
//ERROR_DIR = "C:/Exports/SILO/silo_error/";
//SAV_DIR = "C:/Exports/SILO/silo_sav/";

// GS_EXE = "C:/Program Files/gs/gs9.10/bin/gswin64c.exe";
...
function writePagePlan(physPages) {
    ...
    // Write PDF & JPEG
    var dstPath = DATE_PATH + "plan/" + PLAN_UUID;
...
function writePage(physPage) {
    ...
    objectLink.addAttribute(new Attribute("extRef", PLAN_UUID));
    objectLinks.appendChild(objectLink);
...
//    if (storyItem.items.length == 0 && charsCount < 100 && mycharsCount < 100) {
    if (storyItem.items.length == 0 && mycharsCount < 100) {
...
function convertPdf2(srcFile, dstFile, previewFile, thumbFile, res, shape, affine) {
    ...
    if (affine.ro == "0" && affine.sx > 0 && affine.sy > 0) {
        ...
        if ("11.0.2395236506.pdf" == dstFile.getName())
